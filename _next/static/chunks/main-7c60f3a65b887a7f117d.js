  ...
  [7],
  {
    ...
    IKlv: function(e, t, n) {
              ...
              function(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 30:
                      return (
                        (t.router = z = (0, N.createRouter)(M, I, X, {
                          initialProps: R,
                          pageLoader: G,
                          App: Q,
                          Component: Z,
      ...
      function ue(e) {
        ...
        return (
          console.error(n),
          G.loadPage("/_error").then(function(r) {
            var o = r.page,
              a = r.styleSheets,
              i = pe(t),
              u = {
                ...
                AppTree: i,
                router: z,
                ctx: { err: n, pathname: M, query: I, asPath: X, AppTree: i }
              };
      ...
      var pe = function(e) {
        return function(t) {
          var n = (0, h.default)({}, t, { Component: Z, err: k, router: z });
          return m.default.createElement(
            de,
            null,
      ...
      function he(e) {
        ...
        var i = (0, h.default)({}, r, { Component: n, err: o, router: z });
        Y = i;
        var u,
          c = !1,
