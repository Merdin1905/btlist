  ...
  [1],
  {
    ...
    yl30: function(e, t, n) {
          ...
          for (var e in V) {
            ...
            if (!j[n]) {
              ...
              for (var r in ((j[n] = t), (n = t.eventTypes))) {
                ...
                if (c) {
                  for (l in c) c.hasOwnProperty(l) && Q(c[l], o, u);
                  l = !0;
                } else
                  i.registrationName
                    ? (Q(i.registrationName, o, u), (l = !0))
                    : (l = !1);
      ...
      var Yn = Hn.extend({ data: null }),
        ...
        Gn = [9, 13, 27, 32],
        Jn = q && "CompositionEvent" in window,
        Zn = null;
      q && "documentMode" in document && (Zn = document.documentMode);
      var er = q && "TextEvent" in window && !Zn,
        tr = q && (!Jn || (Zn && 8 < Zn && 11 >= Zn)),
      ...
      var Wr = q && "documentMode" in document && 11 >= document.documentMode,
        Qr = {
          select: {
            phasedRegistrationNames: {
              bubbled: "onSelect",
        ...
        return Br || null == jr || jr !== fn(n)
          ...
          : ("selectionStart" in (n = jr) && hn(n)
            ...
            Hr && Vr(Hr, n)
              ? null
              : ((Hr = n),
                ((e = Hn.getPooled(Qr.select, $r, e, t)).type = "select"),
                (e.target = jr),
                An(e),
                e));
      }
      ...
      function Ti(e) {
        ...
        function p(e, t, n, r) {
          ...
          if ("object" === typeof n && null !== n) {
            ...
            if (ki(n) || D(n)) return null !== l ? null : f(e, t, n, r, null);
            Ei(e, n);
          }
          return null;
        }
        function m(e, t, n, r, l) {
          ...
          if ("object" === typeof r && null !== r) {
            ...
            if (ki(r) || D(r)) return f(t, (e = e.get(n) || null), r, l, null);
            Ei(t, r);
          }
          return null;
        }
      ...
      function ha(e, t, n) {
        ...
        if (
          ...
          (Hi = !0), (l.expirationTime = Wi), (Qi.expirationTime = Wi);
        else {
          if (
            0 === e.expirationTime &&
                    ...
                    "children" === u
                      ? "string" === typeof c
                        ...
                        : "number" === typeof c &&
                          r.textContent !== "" + c &&
                          (e = ["children", "" + c])
                      : H.hasOwnProperty(u) && null != c && cn(n, u);
                  }
                switch (i) {
                  case "input":
                    we(r), Ce(r, o, !0);
      ...
      function Xo(e, t) {
        ...
        return (
          null !== l && (So === l && (ou(t), Po === Eo && Iu(l, _o)), Fu(l, t)),
          l
        );
      }
      function Go(e) {
      ...
      function wu(e, t, n) {
        ...
        null !== r && r.delete(t),
          So === e && _o === n
            ? Po === Eo || (Po === xo && 1073741823 === zo && Vl() - Fo < 500)
              ? ru(e, _o)
              : (Io = !0)
            : Mu(e, n) &&
