    ...
    elyg: function(e, t, r) {
      ...
      function P(e) {
        return (function(e, t) {
          return t && e.startsWith("/")
            ? "/" === e
              ? (0, u.normalizePathTrailingSlash)(t)
              : "".concat(t).concat(e)
            : e;
        })(e, "");
      }
            ...
            return (
              ...
              (s || e in i) &&
                (n =
                  n.replace(
                    u,
                    a ? t.map(y.default).join("/") : (0, y.default)(t)
                  ) || "/")
            );
          }) || (n = ""),
          { params: s, result: n }
      ...
      function E(e, t, r) {
        ...
        try {
          ...
          var v =
            o.origin === n.origin ? o.href.slice(o.origin.length) : o.href;
          return r ? [v, i || v] : v;
        } catch (m) {
          return r ? [a] : a;
        }
      ...
      function j(e, t, r) {
        return { url: P(E(e.pathname, t)), as: r ? P(E(e.pathname, r)) : r };
      }
      function I(e, t) {
          ...
          i(this, e),
            ...
            (this.onPopState = function(e) {
              ...
              if (t) {
                if (t.__N) {
                  ...
                  (o.isSsr && n === o.asPath && i === o.pathname) ||
                    ...
                    o.change(
                      ...
                      r,
                      n,
                      Object.assign({}, a, { shallow: a.shallow && o._shallow })
                    );
                }
              } else {
                var s = o.pathname,
                ...
                o.changeState(
                  "replaceState",
                  (0, h.formatWithValidation)({ pathname: P(s), query: u }),
                  (0, h.getURL)()
                );
              }
            }),
            ...
            (this.query = r),
            (this.asPath =
              (0, f.isDynamicRoute)(t) && __NEXT_DATA__.autoExport ? t : n),
            (this.basePath = ""),
            (this.sub = g),
            (this.clc = null),
            (this._wrapApp = d),
        ...
        return (
          s(e, [
                          ...
                          switch ((t.prev = t.next)) {
                            ...
                            case 3:
                              if (
                                ...
                                (o = _(o, this.locale, this.defaultLocale)),
                                (s = w(S(o) ? k(o) : o, this.locale)),
                                (this._inFlightRoute = o),
                                i._h || !this.onlyAHashChange(s))
                              ) {
                                t.next = 17;
                                break;
                              }
                              return (
                                (this.asPath = s),
                                e.events.emit("hashChangeStart", o),
                                this.changeState(r, n, o, i),
                                this.scrollToHash(s),
                                this.notify(this.components[this.route]),
                                e.events.emit("hashChangeComplete", o),
                                t.abrupt("return", !0)
                              );
                            case 17:
                              return (
                                (t.next = 19), this.pageLoader.getPageList()
                              );
                            case 19:
                              return (
                                (c = t.sent),
                            ...
                            case 22:
                              if (
                                ...
                                (g = (y = d).pathname),
                                (b = y.query),
                                (d = this._resolveHref(d, c)).pathname !== g &&
                                  ((g = d.pathname),
                                  (n = (0, h.formatWithValidation)(d))),
                                (g = g
                                  ? (0, u.removePathTrailingSlash)(k(g))
                                  : g),
                                this.urlIsNew(s) || (r = "replaceState"),
                                (P = (0, u.removePathTrailingSlash)(g)),
                                (E = i.shallow),
                                (O = void 0 !== E && E),
                                (L = w(k((L = o)), this.locale)),
                              ...
                              if (
                                ((j = (0, p.parseRelativeUrl)(L)),
                                (I = j.pathname),
                                (A = (0, m.getRouteRegex)(P)),
                                (T = (0, v.getRouteMatcher)(A)(I)),
                                (D = (U = P === I) ? R(P, I, b) : {}),
                                T && (!U || D.result))
                              ) {
                                t.next = 49;
                              ...
                              if (
                                !(
                                  (W = Object.keys(A.groups).filter(function(
                                    e
                                  ) {
                                    return !b[e];
                                  })).length > 0
                            ...
                            case 50:
                              return (
                                e.events.emit("routeChangeStart", o),
                                (t.prev = 51),
                                (t.next = 54),
                                this.getRouteInfo(P, g, b, o, O)
                              );
                            case 54:
                              if (
                                ((M = t.sent),
                              ...
                              if (
                                !(H = q.pageProps.__N_REDIRECT).startsWith("/")
                              ) {
                                t.next = 63;
                                break;
                              }
                              if (
                                ((G = (0, p.parseRelativeUrl)(H)),
                                this._resolveHref(G, c),
                                !c.includes(G.pathname))
                              ) {
                                t.next = 63;
                                break;
                              }
                            ...
                            case 65:
                              return (
                                e.events.emit("beforeHistoryChange", o),
                                this.changeState(
                                  r,
                                  n,
                                  _(o, this.locale, this.defaultLocale),
                                  i
                                ),
                                (t.next = 70),
                                this.set(P, g, b, s, M).catch(function(e) {
                            ...
                            case 70:
                              ...
                              throw (e.events.emit("routeChangeError", N, s),
                              N);
                            case 73:
                              return (
                                e.events.emit("routeChangeComplete", o),
                                t.abrupt("return", !0)
                              );
                            case 78:
                              if (
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 2:
                              ...
                              throw (e.events.emit("routeChangeError", r, i),
                            ...
                            case 26:
                              return (
                                ...
                                t.abrupt(
                                  "return",
                                  this.handleRouteInfoError(t.t1, n, o, i, !0)
                                )
                              );
                            case 29:
                            case "end":
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 27:
                              return (
                                ...
                                e.abrupt(
                                  "return",
                                  this.handleRouteInfoError(e.t1, r, n, o)
                                )
                              );
                            case 30:
                            case "end":
            ...
            },
            {
              ...
              value: function(e, t) {
                var r =
                    ...
                    arguments[2],
                  n = e.pathname,
                  a = (0, u.removePathTrailingSlash)(
                    (0, c.denormalizePagePath)(r ? k(n) : n)
                  );
                return (
                  "/404" === a ||
                    "/_error" === a ||
                    ...
                    t.some(function(t) {
                      if (
                        ...
                        (0, m.getRouteRegex)(t).re.test(a)
                      )
                        return (e.pathname = r ? P(t) : t), !0;
                    }),
                  e
                );
              }
                      ...
                      function(e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 6:
                              (s = e.sent),
                                (o = this._resolveHref(o, s)).pathname !== i &&
                                  ((i = o.pathname),
            ...
            },
            {
              ...
              value: function(t) {
                this.clc &&
                  (e.events.emit("routeChangeError", b(), t),
                  this.clc(),
                  (this.clc = null));
              }
            },
